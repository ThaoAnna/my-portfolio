  ...
  return (
    <section id="skills" className="py-20 px-6 max-w-4xl mx-auto bg-gray-50">
      ...
      <div className="flex gap-4">
        <section>
          <img className="py-5 px-5 w-40 h-40" src={htmlLogo} alt="HTML logo" />
          <a className="bg-[#68B5FF] text-white font-medium px-6 py-3 rounded-full hover:bg-[#4EA5F7] transition-colors">
          HTML
        </a>
        </section>
        <section>
          <img className="py-5 px-5 w-40 h-40" src={tailwindLogo} alt="Tailwind logo" />
          <a className="bg-[#68B5FF] text-white font-medium px-6 py-3 rounded-full hover:bg-[#4EA5F7] transition-colors">
          Tailwind
        </a>
        </section>
        <section>
          <img className="py-5 px-5-2 w-40 h-40" src={javascriptLogo} alt="JavaScript logo" />
          <a className="bg-[#68B5FF] text-white font-medium px-6 py-3 rounded-full hover:bg-[#4EA5F7] transition-colors">
          JavaScript
        </a>
        </section>
        <section>
          <img className="py-5 px-5 w-40 h-40" src={reactLogo} alt="React logo" />
          <a className="bg-[#68B5FF] text-white font-medium px-6 py-3 rounded-full hover:bg-[#4EA5F7] transition-colors">
          React
        </a>
        </section>
        <section>
          <img className="py-5 px-5 w-40 h-40" src={javaLogo} alt="Java logo" />
